...
class DBHelper(context: Context):SQLiteOpenHelper(context, "userdata", null, 1) {
    ...
    override fun onCreate(p0: SQLiteDatabase?) {
        ...
        p0?.execSQL("create table Userdata (username TEXT primary key, email Text, ContactNo Text, password TEXT)")
    }
    ...
    fun insertdata(username: String, password: String, contactno: String, email: String): Boolean {
